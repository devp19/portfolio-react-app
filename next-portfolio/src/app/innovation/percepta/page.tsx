          ...
          <Navbar className="mt-7">
            ...
            <NavBody>
              ...
              <div className="absolute top-2 right-6 z-[10000] flex items-center gap-2 pointer-events-auto">
                <a href="https://github.com/devp19/percepta" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
                  <FiGithub size={18} color="#e5e7eb" />
                </a>
                <a href="https://percepta-demo.vercel.app/" aria-label="External Link" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
                  <FiExternalLink size={18} color="#e5e7eb" />
                </a>
              </div>
            </NavBody>
            {/* Mobile Nav */}
              ...
              <MobileNavMenu isOpen={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="bg-[rgba(10,10,10,0.7)] backdrop-blur-md">
                <div className="flex flex-col w-full gap-4">
                  ...
                  <div className="flex flex-row gap-3 mt-2">
                    <a href="https://github.com/devp19/percepta" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-neutral-800 transition cursor-pointer">
                      <FiGithub size={18} color="white" />
                    </a>
                    <a href="https://percepta-demo.vercel.app/" aria-label="External Link" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-neutral-800 transition cursor-pointer">
            ...
            <div className="flex flex-col items-start w-full mt-6">
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                ...
                <span className="flex items-center gap-2 ml-3">
                  {/* GitHub */}
                  <a href="https://github.com/devp19/percepta" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              >
                Real-time visual intelligence pipeline: OpenCV image processing, YOLOv5 object detection, and context-aware NLP for AI-driven scene comprehension.
              </TextAnimate>
              ...
              <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-7 text-sm">4 Months, January 2024 - April 2024</p>
                  <h3 className="text-white text-lg font-regular mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    Percepta is a real-time visual intelligence system that combines advanced computer vision and natural language processing to generate scene-level understanding from live video streams.
                  </p>
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    The pipeline integrates OpenCV for image preprocessing, YOLOv5 for object detection, and transformer-based NLP models for context-aware scene description. Results are streamed to a web dashboard via Socket.io, enabling instant, AI-driven comprehension of complex environments.
                  </p>
                </div>
              </div>
            </div>
