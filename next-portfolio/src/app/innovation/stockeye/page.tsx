...
export default function StockEyePage() {
          ...
          <Navbar className="mt-7">
            ...
            <NavBody>
              ...
              <div className="absolute top-2 right-6 z-[10000] flex items-center gap-2 pointer-events-auto">
                <a href="https://github.com/devp19/stockeye" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              <MobileNavMenu isOpen={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="bg-[rgba(10,10,10,0.7)] backdrop-blur-md">
                <div className="flex flex-col w-full gap-4">
                  ...
                  <div className="flex flex-row gap-3 mt-2">
                    <a href="https://github.com/devp19/stockeye" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-neutral-800 transition cursor-pointer">
            ...
            <div className="flex flex-col items-start w-full mt-6">
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                ...
                <span className="flex items-center gap-2 ml-3">
                  <a href="https://github.com/devp19/stockeye" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              >
                A Discord bot for automated financial research: web-scraping corporate metrics, integrating LLM-driven summaries, generating private “portfolio” channels, and planning ML-enabled stock-movement prediction from time-series data.
              </TextAnimate>
              ...
              <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-7 text-sm">2 Months, February 2024 - March 2024</p>
                  <h3 className="text-white text-lg font-regular mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    StockEye is a Discord bot designed to automate financial research and portfolio management for users and communities.
                  </p>
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    It scrapes corporate metrics, generates LLM-powered summaries, creates private portfolio channels, and lays the groundwork for ML-based stock movement prediction using time-series data. Built with Node.js, Discord.js, and Python, StockEye streamlines research and collaboration in financial Discord servers.
                  </p>
                </div>
              </div>
            </div>
