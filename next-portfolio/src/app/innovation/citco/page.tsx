...
export default function CitcoPage() {
          ...
          <Navbar className="mt-7">
            ...
            <NavBody>
              ...
              <div className="absolute top-2 right-6 z-[10000] flex items-center gap-2 pointer-events-auto">
                <a href="https://github.com/devp19/citco" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              <MobileNavMenu isOpen={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="bg-[rgba(10,10,10,0.7)] backdrop-blur-md">
                <div className="flex flex-col w-full gap-4">
                  ...
                  <div className="flex flex-row gap-3 mt-2">
                    <a href="https://github.com/devp19/citco" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-neutral-800 transition cursor-pointer">
            ...
            <div className="flex flex-col items-start w-full mt-6">
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                ...
                <span className="flex items-center gap-2 ml-3">
                  <a href="https://github.com/devp19/citco" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              >
                A web-based research analytics platform that examines the relationship between public funding and academic impact among Canadian computer science researchers. Citco cross-references grant data with citation records, allowing users to filter by year, institution, or domain and visualize 15-year trends.
              </TextAnimate>
              ...
              <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-7 text-sm">2 Months, June 2023 - July 2023</p>
                  <h3 className="text-white text-lg font-regular mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    Citco is a research analytics platform focused on Canadian computer science, providing insights into the impact of public funding on academic output.
                  </p>
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    The platform cross-references grant and citation data, enabling users to filter by year, institution, or domain and visualize trends over 15 years. Built with Next.js, Typescript, Python, and Plotly, Citco empowers data-driven research policy and discovery.
                  </p>
                </div>
              </div>
            </div>
