          ...
          <Navbar className="mt-7">
            ...
            <NavBody>
              ...
              <div className="absolute top-2 right-6 z-[10000] flex items-center gap-2 pointer-events-auto">
                <a href="https://github.com/devp19/near-fantasy" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              <MobileNavMenu isOpen={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="bg-[rgba(10,10,10,0.7)] backdrop-blur-md">
                <div className="flex flex-col w-full gap-4">
                  ...
                  <div className="flex flex-row gap-3 mt-2">
                    <a href="https://github.com/devp19/near-fantasy" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-neutral-800 transition cursor-pointer">
            ...
            <div className="flex flex-col items-start w-full mt-6">
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                ...
                <span className="flex items-center gap-2 ml-3">
                  <a href="https://github.com/devp19/near-fantasy" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition cursor-pointer">
              ...
              >
                A decentralized fantasy sports platform that merges real-world gameplay with blockchain-backed digital ownership. NEAR Fantasy leverages smart contracts and wallet-based identity to let users draft, trade, and compete using tokenized player assets in real-time.
              </TextAnimate>
              ...
              <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-7 text-sm">3 Months, May 2023 - July 2023</p>
                  <h3 className="text-white text-lg font-regular mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    NEAR Fantasy is a decentralized fantasy sports platform that bridges real-world sports with blockchain technology, enabling true digital ownership and transparent gameplay.
                  </p>
                  <p className="text-[#b0b0b0] mb-3 text-sm">
                    Users can draft, trade, and compete with tokenized player assets, all secured by NEAR smart contracts and wallet-based authentication. The platform is built with Next.js, Typescript, and Rust, leveraging the NEAR Protocol for seamless, scalable blockchain integration.
                  </p>
                </div>
              </div>
            </div>
